...
export const initDb = async () => {
    try {
        await pool.query(`
            ...
            VALUES 
                ('/', 'Home', 'Welcome to WormLabs', 'Home | WormLabs', 'Home09Icon', '', true, true, 0, NULL),
                ('/about', 'About Us', 'Learn more about WormLabs', 'About Us | WormLabs', 'InformationCircleIcon', '', true, false, 1, NULL),
                ('/pricing', 'Pricing', 'View our pricing plans', 'Pricing | WormLabs', 'Wallet03Icon', 'Developers', true, true, 32, NULL),
                ('/agents', 'A2A Agents', 'Manage your AI agents', 'Agents | WormLabs', 'AiScanIcon', 'Playground', false, true, 10, NULL),
                ('/agent-create', 'Create Agent', 'Build a new AI agent', 'Create Agent | WormLabs', 'Add01Icon', 'Playground', false, true, 11, NULL),
                ('/mcp', 'MCP', 'Manage Model Context Protocol servers', 'MCP | WormLabs', 'McpServerFreeIcons', 'Capabilities', false, true, 20, NULL),
                ('/tools', 'Tools', 'Configure external tools', 'Tools | WormLabs', 'ToolsIcon', 'Capabilities', false, true, 21, NULL),
                ('/knowledge-base', 'Knowledge Base', 'Manage RAG knowledge bases', 'Knowledge Base | WormLabs', 'BrainIcon', 'Capabilities', false, true, 22, NULL),
                ('/knowledge-graph', 'Knowledge Graph', 'Visualize knowledge graphs', 'Knowledge Graph | WormLabs', 'AiNetworkIcon', 'Capabilities', false, true, 23, NULL),
                ('/api-keys-management', 'API Keys', 'Manage access tokens', 'API Keys | WormLabs', 'KeyIcon', 'Developers', false, true, 30, NULL),
                ('/usage', 'Usage', 'Monitor usage and costs', 'Usage | WormLabs', 'PieChartIcon', 'Developers', false, true, 31, NULL),
                ('/billing', 'Billing', 'Manage billing information', 'Billing | WormLabs', 'Invoice01Icon', 'Developers', false, true, 33, NULL),
                ('/profile', 'Profile', 'Manage your user profile', 'Profile | WormLabs', 'UserIcon', 'General', false, false, 40, NULL),
                ('/design-system', 'Design System', 'UI Components', 'Design System | WormLabs', 'BrandfetchIcon', 'Platform Admin', false, true, 50, 'platform-admin'),
                ('/users', 'Users', 'Manage platform users', 'Users | WormLabs', 'UserIcon', 'Platform Admin', false, true, 51, 'platform-admin'),
                ('/platform-features', 'Platform Features', 'Configure platform features', 'Platform Features | WormLabs', 'Settings01Icon', 'Platform Admin', false, true, 52, 'platform-admin'),
                ('/platform-roles', 'Platform Roles', 'Manage roles and permissions', 'Platform Roles | WormLabs', 'AiNetworkIcon', 'Platform Admin', false, true, 53, 'platform-admin'),
                ('/platform-prompts', 'System Prompts', 'Manage system templates', 'System Prompts | WormLabs', 'File01Icon', 'Platform Admin', false, true, 54, 'platform-admin'),
                ('/revenue', 'Revenue', 'Monitor platform financial performance', 'Revenue | WormLabs', 'Wallet02Icon', 'Platform Admin', false, true, 55, 'platform-admin')
